    ...
    <PageShell overlay={true}>
      <main>
        <section className="hero">
          <img className="hero-media" src="https://images.unsplash.com/photo-1556229010-6c3f2c9ca5f8?auto=format&fit=crop&w=2000&q=88" alt="Botanical skincare arranged in soft morning light" />
